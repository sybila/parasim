...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            // check input
            if (!options.isServer() && options.getExperimentFile() == null) {
    ...
    private static void startServer() throws RemoteException, InterruptedException {
        manager.resolve(Loader.class, Default.class).load(Loader.class, Default.class);
