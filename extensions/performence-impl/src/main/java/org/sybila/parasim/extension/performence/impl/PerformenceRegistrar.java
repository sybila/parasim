 ...
 */
public class PerformenceRegistrar {

    @Provide
    public Performence providePerformence(InterceptorRegistry interceptorRegistry) {
        return new PerformenceImpl(interceptorRegistry);
    }
