 ...
 */
public class CycleDetectionRegistrar {

    @Provide
    public CycleDetectionConfiguration provideConfiguration(ParasimDescriptor descriptor, ExtensionDescriptorMapper mapper) throws IllegalAccessException {
        CycleDetectionConfiguration configuration = new CycleDetectionConfiguration();
        ExtensionDescriptor extensionDescriptor = descriptor.getExtensionDescriptor("cycledetection");
    ...
    @Provide
    public CycleDetectorFactory provideFactory(CycleDetectionConfiguration configuration) {
        return new ExtremesCycleDetectorFactory(configuration.getRelativeTolerance());
    }
