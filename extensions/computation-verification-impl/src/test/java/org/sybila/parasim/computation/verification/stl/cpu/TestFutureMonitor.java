...
import org.sybila.parasim.computation.verification.stl.cpu.FutureMonitor;
...
public class TestFutureMonitor extends AbstractMonitorTest {
    ...
    public void testFutureMonitor() {
        ...
        Monitor future = new FutureMonitor(subMonitor, new TimeInterval(2, 4, IntervalBoundaryType.CLOSED));
