 ...
 */
public class SequentialFactorial implements Computation<MultiplicativeInteger> {
    ...
    public SequentialFactorial(Integer n) {
        this.n = n;
    }
    ...
    public MultiplicativeInteger call() throws Exception {
        ...
        if (n > 1) {
            emitter.emit(new SequentialFactorial(n - 1));
        }
