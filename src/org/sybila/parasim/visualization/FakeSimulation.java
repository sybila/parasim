...
import org.sybila.parasim.computation.*;
...
public class FakeSimulation {
     ...
     * @return 
     */
    final DirectedPoint createStartPoint (final float [] positions, final DirectedPoint [] corners, final float distances_sum) {
