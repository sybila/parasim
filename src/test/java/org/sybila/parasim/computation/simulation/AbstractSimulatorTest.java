...
public abstract class AbstractSimulatorTest<Conf extends Configuration, Out extends DataBlock> {
    ...
    private org.sybila.parasim.computation.ArrayDataBlock<Trajectory> createDataBlock(int dim, int size) {
        ...
        return new org.sybila.parasim.computation.ArrayDataBlock<Trajectory>(trajectories);
    }
