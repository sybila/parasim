...
public class TestOnePairAbsoluteDistanceChecker {
    ...
    private org.sybila.parasim.computation.DataBlock<Trajectory> simpleDataBlock;
    ...
    private org.sybila.parasim.computation.DataBlock<Trajectory> getSimpleDataBlock() {
    ...
    private TrajectoryNeighborhood<Trajectory> getSimpleNeighborHood() {
        if (simpleNeighborHood == null) {
            final Map<Trajectory, org.sybila.parasim.computation.DataBlock<Trajectory>> neighborhoods = new HashMap<Trajectory, org.sybila.parasim.computation.DataBlock<Trajectory>>();
            for (int t = 0; t < DATABLOCK_SIZE; t++) {
