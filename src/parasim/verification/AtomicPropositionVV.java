...
/**
 * Proposition of type Variable op Variable
 * @author sven
 */
public class AtomicPropositionVV implements Evaluable
{
   ...
   *
   * @param var1 index of the first variable the AP speaks about
