 ...
 */
public class ManagedIntercepted<T extends Object> extends AbstractIntercepted<T> {
    private Manager manager;

    public ManagedIntercepted(Manager manager, T targetObject) {
        super(targetObject);
        ...
        try {
            MethodHandler methodHandler = new MethodHandler() {
                ...
                public Object invoke(final Object o, final Method thisMethod, final Method proceed, final Object[] args) throws Throwable {
                    ...
                    for (final Interceptor interceptor: manager.service(Interceptor.class)) {
                        final Invocation interceptedInvocation = invocation;
                        invocation = new Invocation() {
                            @Override
                            public Object invoke(Object target, Method method, Object... args) throws Throwable {
